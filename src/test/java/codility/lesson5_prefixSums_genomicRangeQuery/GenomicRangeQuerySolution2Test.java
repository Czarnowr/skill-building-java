package codility.lesson5_prefixSums_genomicRangeQuery;
...
public class GenomicRangeQuerySolution2Test {
    private static GenomicRangeQuerySolution2 solver = new GenomicRangeQuerySolution2();
